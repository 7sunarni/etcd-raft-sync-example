...
func TestPutAndGetKeyValue(t *testing.T) {
	...
	commitC, errorC, snapshotterReady, _ := newRaftNode(1, clusters, false, getSnapshot, proposeC, confChangeC)

	kvs = newKVStore(<-snapshotterReady, proposeC, commitC, errorC, nil)
